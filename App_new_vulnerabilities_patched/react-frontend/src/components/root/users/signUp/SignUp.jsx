...
const SignUp = () => {
  ...
  const validate = () => {
    ...
    /*
    var regexUsername = new RegExp(info.username);
    if (regexUsername.test(info.password)){
      errors.password = "Password contains username. Please provide another password.";
    }
    */
    if (info.password.includes(info.username)) {
      errors.password = "Password contains username. Please provide another password.";
    }
  ...
  const handleImageChange = (event) => {
    setInfo({ ...info, profileImage: event.target.files[0] });
  };
      ...
      <main className={styles.form_style}>
        ...
        <form className={styles.signup_form} onSubmit={submitHandler}>
          ...
          <section className={styles.form_field}>
            ...
            />
            <label htmlFor="profileImage" className={styles.label_name}>
              <span className={styles.content_name}>Profile Image</span>
            </label>
          </section>
          <section className={styles.form_field}>
