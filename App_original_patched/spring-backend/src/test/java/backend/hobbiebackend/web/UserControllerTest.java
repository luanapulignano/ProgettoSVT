...
import backend.hobbiebackend.security.PasswordManager;
...
class UserControllerTest extends AbstractTest {
    ...
    public void setUp() {
        ...
        List<String> pwdList = pwdManager.readPasswordFile();
        
        // prepare data client
        appClientSignUpDto = new AppClientSignUpDto();
        appClientSignUpDto.setUsername("user");
        appClientSignUpDto.setPassword(pwdList.get(6));
        ...
        updateAppClientDto.setPassword(pwdList.get(5));
        ...
        businessRegisterDto.setPassword(pwdList.get(4));
        ...
        updateBusinessDto.setPassword(pwdList.get(3));
